...
ALARM_PATH := vendor/mythic/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/mythic/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/mythic/prebuilt/common/media/audio/ringtones
